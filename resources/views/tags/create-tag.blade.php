...
<body>
  ...
  @include('user.navbar')
        ...
        <div class="container">
            <div class="row">
                <h1 class="text-center" style="margin-top:15px; text-transform:uppercase;">Create Tag</h1>
                       <form class="row" method="post" enctype="multipart/form-data" action="{{route('tags.store') }}">
                       @csrf
