    ...
    <div class="container">
      <div class="row">
        <div class="offset-lg-2 col-lg-8 col-md-12 col-12 mb-12">
          <!-- caption-->
          <h1 class="display-2 fw-bold mb-3">Hi there, we’re <span class="text-primary">Geeks</span></h1>
          <!-- para -->
      ...
      <div class="gallery mb-12">
       <!-- gallery-item -->
        <figure class="gallery__item gallery__item--1 mb-0">
          <img src="images/about/geeksui-img-1.jpg" alt="Gallery image 1" class="gallery__img rounded-3">
        </figure>
         <!-- gallery-item -->
        <figure class="gallery__item gallery__item--2 mb-0">
          <img src="images/about/geeksui-img-2.jpg" alt="Gallery image 2" class="gallery__img rounded-3">
        </figure>
         <!-- gallery-item -->
        <figure class="gallery__item gallery__item--3 mb-0">
          <img src="images/about/geeksui-img-3.jpg" alt="Gallery image 3" class="gallery__img rounded-3">
        </figure>
         <!-- gallery-item -->
        <figure class="gallery__item gallery__item--4 mb-0">
          <img src="images/about/geeksui-img-4.jpg" alt="Gallery image 4" class="gallery__img rounded-3">
        </figure>
          <!-- gallery-item -->
        <figure class="gallery__item gallery__item--5 mb-0">
          <img src="images/about/geeksui-img-5.jpg" alt="Gallery image 5" class="gallery__img rounded-3">
        </figure>
         <!-- gallery-item -->
        <figure class="gallery__item gallery__item--6 mb-0">
          <img src="images/about/geeksui-img-6.jpg" alt="Gallery image 6" class="gallery__img rounded-3">
        </figure>
      </div>
      <div class="row">
         <!-- row -->
      ...
      <div class="row">
        <div class="col-md-2 col-3">
          <div class="p-xl-5 p-lg-3 mb-3 mb-lg-0">
             <!-- avatar -->
            <img src="images/avatar/avatar-1.jpg" alt="" class="imgtooltip img-fluid rounded-circle" data-template="one">
             <!-- text -->
        ...
        <div class="col-md-2 col-3">
          <div class="p-xl-5 p-lg-3 mb-3 mb-lg-0">
            <!-- avatar -->
            <img src="images/avatar/avatar-2.jpg" alt="" class="imgtooltip img-fluid rounded-circle" data-template="two">
            <!-- text -->
        ...
        <div class="col-md-2 col-3">
          <div class="p-xl-5 p-lg-3 mb-3 mb-lg-0">
            <!-- avatar -->
            <img src="images/avatar/avatar-3.jpg" alt="" class="imgtooltip img-fluid rounded-circle" data-template="three">
            <!-- text -->
        ...
        <div class="col-md-2 col-3">
          <div class="p-xl-5 p-lg-3 mb-3 mb-lg-0">
            <!-- avatar -->
            <img src="images/avatar/avatar-4.jpg" alt="" class="imgtooltip img-fluid rounded-circle" data-template="four">
            <!-- text -->
        ...
        <div class="col-md-2 col-3">
          <div class="p-xl-5 p-lg-3 mb-3 mb-lg-0">
            <!-- avatar -->
            <img src="images/avatar/avatar-5.jpg" alt="" class="imgtooltip img-fluid rounded-circle" data-template="five">
            <!-- text -->
        ...
        <div class="col-md-2 col-3">
          <div class="p-xl-5 p-lg-3 mb-3 mb-lg-0">
            <!-- avatar -->
            <img src="images/avatar/avatar-6.jpg" alt="" class="imgtooltip img-fluid rounded-circle" data-template="six">
            <!-- text -->
        ...
        <div class="col-md-2 col-3">
          <div class="p-xl-5 p-lg-3 mb-3 mb-lg-0">
            <!-- avatar -->
            <img src="images/avatar/avatar-7.jpg" alt="" class="imgtooltip img-fluid rounded-circle" data-template="seven">
            <!-- text -->
        ...
        <div class="col-md-2 col-3">
          <div class="p-xl-5 p-lg-3 mb-3 mb-lg-0">
            <!-- avatar -->
            <img src="images/avatar/avatar-8.jpg" alt="" class="imgtooltip img-fluid rounded-circle" data-template="eight">
            <!-- text -->
        ...
        <div class="col-md-2 col-3">
          <div class="p-xl-5 p-lg-3 mb-3 mb-lg-0">
            <!-- avatar -->
            <img src="images/avatar/avatar-9.jpg" alt="" class="imgtooltip img-fluid rounded-circle" data-template="eleven">
            <!-- text -->
        ...
        <div class="col-md-2 col-3">
          <div class="p-xl-5 p-lg-3 mb-3 mb-lg-0">
            <!-- avatar -->
            <img src="images/avatar/avatar-10.jpg" alt="" class="imgtooltip img-fluid rounded-circle" data-template="twelve">
            <!-- text -->
        ...
        <div class="col-md-2 col-3">
          <div class="p-xl-5 p-lg-3 mb-3 mb-lg-0">
            <!-- avatar -->
            <img src="images/avatar/avatar-11.jpg" alt="" class="imgtooltip img-fluid rounded-circle" data-template="thirteen">
            <!-- text -->
        ...
        <div class="col-md-2 col-3">
          <div class="p-xl-5 p-lg-3 mb-3 mb-lg-0">
            <!-- avatar -->
            <img src="images/avatar/avatar-12.jpg" alt="" class="imgtooltip img-fluid rounded-circle" data-template="fourteen">
            <!-- text -->
