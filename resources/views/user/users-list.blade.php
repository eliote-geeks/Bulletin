    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 offset-right-md-6 col-12 mb-6">
          <!-- caption -->
          <h2 class="display-4 mb-3 fw-bold">Users</h2>
        </div>
      </div>
        ...
        <div class="col-md-4 col-12">
          ...
          <div class="card mb-4 mb-lg-0">
            ...
            <div class="card-body p-5">
              ...
              <h3 class="mb-2">{{$user->name}}</h3><br> <span> </span>                
                <a href="{{route('users.delete_user',$user)}}" class="btn-sm btn-danger" onclick="return(confirm('Are you sure to delete this user ? '))">Delete</a>
            </div>
          </div>
        </div>
@empty
