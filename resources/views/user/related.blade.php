           ...
           <div class="col-xl-4 col-lg-4 col-md-6 col-12">
            <!-- Card -->
             <div class="card mb-4 shadow-lg">
              <a href="{{route('blog-single.show',$post)}}"  class="card-img-top"> <img src="{{ $post->imagePath}}" class="card-img-top rounded-top-md"
                  alt=""></a>
              <!-- Card body -->
              <div class="card-body">
                <a href="{{route('blog-category.show_category',['category'=>$post->category->name])}}" class="fs-5 fw-semi-bold d-block mb-3 text-danger">{{$post->category->name}}</a>
